...
>(
  (
    ...
    // We add a state so that we can use it as a data-state attribute.
    // This allows us to style based on the state.
      ...
      >
        ...
        <div
          className={cn(
            ...
            "top-[var(--sidebar-top,0px)] h-[calc(100svh-var(--sidebar-top,0px))]",
            side === "left"
